...
export default function UsersPage() {
 ...
 const confirmDeleteUser = async (userId: string) => {
   try {
    // 1. Get the user's email from the Users collection
    ...
    // 2. Delete all events created by this email
    const eventsRef = collection(db, "Events");
    const q = query(eventsRef, where("createdBy", "==", userEmail));
    ...
    // 4. Update UI state (if you keep users in state)
    setUsers((prev) => prev.filter((u) => u.id !== userId));

    console.log(`User ${userEmail} and all their events deleted successfully.`);
  } catch (error) {
              ...
              >
                ...
                <TableCell className='text-gray-400'>
                  <div className='flex gap-2'>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button variant='default'>Delete user</Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                          ...
                          <AlertDialogDescription>
                            ...
                            delete this user and remove all their data
                            (including events) from our servers.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
